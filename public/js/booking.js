...
var bookingBigOpt = document.querySelectorAll('.booking-data-option');
bookingBigOpt.forEach(function (bookOption) {
  var bookingButton = bookOption.querySelector('.booking-data-dropdown');
  bookingButton.addEventListener('click', function () {
    bookingButton.classList.toggle('booking-data-dropdown--open');
    var bookingOption = bookOption.querySelector('.booking-datas');
